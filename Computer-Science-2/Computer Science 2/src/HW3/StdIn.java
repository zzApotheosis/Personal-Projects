...
//    }
    ...
    public static String readAll() throws IOException {
        ...
        String s = readFile("/home/zzapotheosis/Desktop/CS2 HW3/tale.txt");
     ...
     */
    public static int[] readAllInts() throws IOException {
     ...
     */
    public static long[] readAllLongs() throws IOException {
        String[] fields = readAllStrings();
     ...
     */
    public static double[] readAllDoubles() throws IOException {
        String[] fields = readAllStrings();
     ...
     */
    @Deprecated
    public static double[] readDoubles() throws IOException {
