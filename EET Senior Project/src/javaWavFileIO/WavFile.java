package javaWavFileIO;// Wav file IO class
// A.Greensted
...
public class WavFile {
    ...
    // Cannot instantiate javaWavFileIO.WavFile directly, must either use newWavFile() or openWavFile()
    private WavFile() {
    ...
    public int readFrames(int[] sampleBuffer, int offset, int numFramesToRead) throws IOException, WavFileException {
        if (ioState != IOState.READING)
            throw new IOException("Cannot read from javaWavFileIO.WavFile instance");
    ...
    public int writeFrames(int[] sampleBuffer, int offset, int numFramesToWrite) throws IOException, WavFileException {
        if (ioState != IOState.WRITING)
            throw new IOException("Cannot write to javaWavFileIO.WavFile instance");
